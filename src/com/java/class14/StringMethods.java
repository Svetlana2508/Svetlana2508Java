...
public class StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println("Equality ignoring case: " + str1.equalsIgnoreCase(str2));
        ...
        System.out.println("3.1  Contains:" + str3.contains(str2));
        System.out.println("========================");
        ...
        System.out.println("8. Blank : " + str1.isEmpty());
        ...
        System.out.println("10.Format : " + String.format(str1, "Chirag", "to Ebay"));
        System.out.println("========================");
